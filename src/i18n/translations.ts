...
export const translations = {
  ...
  home: {
    heroTitleLine1: {
      pt: 'TRATAMOS DE TODA A SUA',
      en: 'WE TAKE CARE OF ALL YOUR',
    },
    heroTitleLine2: {
      pt: 'ROUPA EM LISBOA!',
      en: 'LAUNDRY IN LISBON!',
    },
    heroSubtitleLine1: {
    ...
    whyChoose: { pt: 'Porquê escolher a GLOAT em Lisboa?', en: 'Why Choose GLOAT in Lisbon?' },
    ...
    ctaSubtitleHome: {
      pt: 'Descubra os nossos serviços ou agende uma recolha em 60 segundos.',
      en: 'Discover our services or book a pickup in 60 seconds.',
    },
