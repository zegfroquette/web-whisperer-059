        ...
        <div className="max-w-3xl mx-auto">
          ...
          {serviceCategories.map((item, i) => (
            ...
            >
              ...
              <Link href={`/${language}/${pt ? item.ptSlug : item.enSlug}`} className="text-primary font-semibold hover:underline">
